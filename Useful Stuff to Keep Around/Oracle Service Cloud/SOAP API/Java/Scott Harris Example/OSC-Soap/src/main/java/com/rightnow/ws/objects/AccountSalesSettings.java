 ...
 */
            ...
            /**
            *  AccountSalesSettings bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        /**
                        * field for DefaultCurrency
                        */

                        
                                    protected com.rightnow.ws.base.NamedID localDefaultCurrency ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localDefaultCurrencyTracker = false ;

                           public boolean isDefaultCurrencySpecified(){
                               return localDefaultCurrencyTracker;
                           }
                           ...
                           */
                           public  com.rightnow.ws.base.NamedID getDefaultCurrency(){
                               return localDefaultCurrency;
                           }
                            ...
                            /**
                               ...
                               * @param param DefaultCurrency
                               */
                               public void setDefaultCurrency(com.rightnow.ws.base.NamedID param){
                            localDefaultCurrencyTracker = param != null;
                                   
                                            this.localDefaultCurrency=param;
                        ...
                        */
                                    ...
                                    protected com.rightnow.ws.nullfields.AccountSalesSettingsNullFields localValidNullFields ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.rightnow.ws.nullfields.AccountSalesSettingsNullFields
                           */
                           public  com.rightnow.ws.nullfields.AccountSalesSettingsNullFields getValidNullFields(){
                            ...
                            /**
                               ...
                               */
                               public void setValidNullFields(com.rightnow.ws.nullfields.AccountSalesSettingsNullFields param){
       ...
       public org.apache.axiom.om.OMElement getOMElement (
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AccountSalesSettings",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localDefaultCurrencyTracker){
                                            if (localDefaultCurrency==null){
                                                 throw new org.apache.axis2.databinding.ADBException("DefaultCurrency cannot be null!!");
                                            }
                                           localDefaultCurrency.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3","DefaultCurrency"),
                                               xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localDefaultCurrencyTracker){
                            elementList.add(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3",
                                    ...
                                    elementList.add(localDefaultCurrency);
                                } if (localTerritoryTracker){
                            elementList.add(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3",
                                                                      "Territory"));
    ...
    public static class Factory{
        ...
        */
        public static AccountSalesSettings parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AccountSalesSettings object =
                new AccountSalesSettings();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AccountSalesSettings".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AccountSalesSettings)com.rightnow.ws.objects.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3","DefaultCurrency").equals(reader.getName())){
                                
                                                object.setDefaultCurrency(com.rightnow.ws.base.NamedID.Factory.parse(reader));
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setValidNullFields(com.rightnow.ws.nullfields.AccountSalesSettingsNullFields.Factory.parse(reader));
