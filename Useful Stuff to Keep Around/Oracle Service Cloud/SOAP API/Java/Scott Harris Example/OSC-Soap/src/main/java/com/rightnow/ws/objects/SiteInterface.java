 ...
 */
            ...
            /**
            *  SiteInterface bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SiteInterface extends com.rightnow.ws.base.RNObject
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3","SiteInterface"));
                 if (localIDTracker){
    ...
    public static class Factory{
        ...
        */
        public static SiteInterface parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SiteInterface object =
                new SiteInterface();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SiteInterface".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SiteInterface)com.rightnow.ws.objects.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
