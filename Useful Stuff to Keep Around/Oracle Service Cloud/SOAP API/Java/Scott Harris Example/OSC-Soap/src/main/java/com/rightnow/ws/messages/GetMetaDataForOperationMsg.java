...
/**
 * GetMetaDataForOperationMsg.java
 *
 ...
 */
            ...
            /**
            *  GetMetaDataForOperationMsg bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = GetMetaDataForOperationMsg
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getOperation(){
                               ...
                               */
                              protected void validateOperation(java.lang.String[] param){
                             ...
                             */
                             public void addOperation(java.lang.String param){
                                   if (localOperation == null){
                                   localOperation = new java.lang.String[]{};
                                   }
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetMetaDataForOperationMsg",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                   ...
                                   for (int i = 0;i < localOperation.length;i++){
                                            ...
                                            if (localOperation[i] != null){
                                                ...
                                                writeStartElement(null, namespace, "Operation", xmlWriter);
                                                        ...
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOperation[i]));
                                  ...
                                  for (int i = 0;i < localOperation.length;i++){
                                         ...
                                         if (localOperation[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_3",
                                                                              "Operation"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOperation[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static GetMetaDataForOperationMsg parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMetaDataForOperationMsg object =
                new GetMetaDataForOperationMsg();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetMetaDataForOperationMsg".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMetaDataForOperationMsg)com.rightnow.ws.objects.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_3","Operation").equals(reader.getName())){
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_3","Operation").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setOperation((java.lang.String[])
                                    ...
                                    // Process the array and step past its final element's end.
                                    list3.add(com.rightnow.ws.generic.RNObjectType.Factory.parse(reader));
