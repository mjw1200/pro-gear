...
/**
 * SharedFileAttachmentIncident.java
 *
 ...
 */
            ...
            /**
            *  SharedFileAttachmentIncident bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SharedFileAttachmentIncident extends com.rightnow.ws.objects.FileAttachmentIncident
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = SharedFileAttachmentIncident
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SharedFileAttachmentIncident",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3","SharedFileAttachmentIncident"));
                 if (localContentTypeTracker){
    ...
    public static class Factory{
        ...
        */
        public static SharedFileAttachmentIncident parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SharedFileAttachmentIncident object =
                new SharedFileAttachmentIncident();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SharedFileAttachmentIncident".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SharedFileAttachmentIncident)com.rightnow.ws.objects.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
