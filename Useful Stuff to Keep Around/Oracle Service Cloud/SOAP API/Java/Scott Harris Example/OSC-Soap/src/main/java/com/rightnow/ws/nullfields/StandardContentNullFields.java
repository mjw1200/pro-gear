...
/**
 * StandardContentNullFields.java
 *
 ...
 */
            ...
            /**
            *  StandardContentNullFields bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = StandardContentNullFields
                ...
                */
                        ...
                        */
                                    ...
                                    protected boolean localContentValues =
                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean("false");
                           ...
                           */
                           public  boolean getContentValues(){
                            ...
                            /**
                               ...
                               */
                               public void setContentValues(boolean param){
                           ...
                           */
                           public  boolean getHotKey(){
                            ...
                            /**
                               ...
                               * @param param HotKey
                               */
                               public void setHotKey(boolean param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":StandardContentNullFields",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                                ...
                                                writeAttribute("",
                                                         "ContentValues",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localContentValues), xmlWriter);
                                                ...
                                                writeAttribute("",
                                                         "HotKey",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localHotKey), xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            attribList.add(
                            new javax.xml.namespace.QName("","ContentValues"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localContentValues));
                            ...
                            new javax.xml.namespace.QName("","HotKey"));
                                      ...
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localHotKey));
    ...
    public static class Factory{
        ...
        */
        public static StandardContentNullFields parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StandardContentNullFields object =
                new StandardContentNullFields();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"StandardContentNullFields".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (StandardContentNullFields)com.rightnow.ws.objects.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribAdminVisibleInterfaces!=null){
                    ...
                    // handle attribute "ContentValues"
                    java.lang.String tempAttribContentValues =
                        
                                reader.getAttributeValue(null,"ContentValues");
                            
                   if (tempAttribContentValues!=null){
                         java.lang.String content = tempAttribContentValues;
                        
                                                 object.setContentValues(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(tempAttribContentValues));
                                            
                    } else {
                       
                    }
                    handledAttributes.add("ContentValues");
                   ...
                   if (tempAttribFolder!=null){
                    ...
                    // handle attribute "HotKey"
                    java.lang.String tempAttribHotKey =
                        
                                reader.getAttributeValue(null,"HotKey");
                            
                   if (tempAttribHotKey!=null){
                         java.lang.String content = tempAttribHotKey;
                        
                                                 object.setHotKey(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(tempAttribHotKey));
                                            
                    } else {
                       
                    }
                    handledAttributes.add("HotKey");
