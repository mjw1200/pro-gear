                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           public boolean isChatIDSpecified(){
                               return localChatIDTracker;
                           }
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                           ...
                                           localMailingID.serialize(new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_3","MailingID"),
                                               xmlWriter);
                                        
                                    namespace = "urn:messages.ws.rightnow.com/v1_3";
                                    writeStartElement(null, namespace, "ScheduledTime", xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localIncidentID==null){
                                        ...
                                        writeStartElement(null, "urn:messages.ws.rightnow.com/v1_3", "IncidentID", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localIncidentID.serialize(new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_3","IncidentID"),
                                        xmlWriter);
                                    }
                                
                                    if (localOpportunityID==null){

                                        writeStartElement(null, "urn:messages.ws.rightnow.com/v1_3", "OpportunityID", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localOpportunityID.serialize(new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_3","OpportunityID"),
                                        xmlWriter);
                                    }
                                 if (localChatIDTracker){
                                           ...
                                           localChatID.serialize(new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_3","ChatID"),
                                               xmlWriter);
                                        }
                    xmlWriter.writeEndElement();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SendMailingToContactMsg".equals(type)){
                                ...
                                return (SendMailingToContactMsg)com.rightnow.ws.objects.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_3","MailingID").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_3","ScheduledTime").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_3","IncidentID").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_3","OpportunityID").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:messages.ws.rightnow.com/v1_3","ChatID").equals(reader.getName())){
