 ...
 */
                ...
                */
                        ...
                        */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           protected boolean localRNObjectsTracker = false ;

                           public boolean isRNObjectsSpecified(){
                               return localRNObjectsTracker;
                           }
                           ...
                           public  com.rightnow.ws.base.RNObject[] getRNObjects(){
                              ...
                              */
                              public void setRNObjects(com.rightnow.ws.base.RNObject[] param){
                               ...
                               localRNObjectsTracker = param != null;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RNObjectsResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RNObjectsResult",
    ...
    public static class Factory{
        ...
        */
        public static RNObjectsResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RNObjectsResult object =
                new RNObjectsResult();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RNObjectsResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RNObjectsResult)com.rightnow.ws.objects.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
