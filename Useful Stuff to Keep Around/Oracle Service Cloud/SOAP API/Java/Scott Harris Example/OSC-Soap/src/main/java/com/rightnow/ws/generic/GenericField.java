 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.rightnow.ws.generic.DataValue localDataValue ;
                                

                           /**
                           * Auto generated getter method
                           * @return com.rightnow.ws.generic.DataValue
                           */
                           public  com.rightnow.ws.generic.DataValue getDataValue(){
                            ...
                            /**
                               ...
                               */
                               public void setDataValue(com.rightnow.ws.generic.DataValue param){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                    ...
                                    if (localDataType != null){
                                        writeAttribute("",
                                           "dataType",
                                           localDataType.toString(), xmlWriter);
                                    }
                                    ...
                                    if (localDataValue==null){
                                        ...
                                        writeStartElement(null, "urn:generic.ws.rightnow.com/v1_3", "DataValue", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localDataValue.serialize(new javax.xml.namespace.QName("urn:generic.ws.rightnow.com/v1_3","DataValue"),
                                        xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("urn:generic.ws.rightnow.com/v1_3",
                                    ...
                                    elementList.add(localDataValue==null?null:
                                    localDataValue);
    ...
    public static class Factory{
        ...
        */
        public static GenericField parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GenericField object =
                new GenericField();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GenericField".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GenericField)com.rightnow.ws.objects.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    java.lang.String tempAttribDataType =
                        
                                reader.getAttributeValue(null,"dataType");
                            
                   if (tempAttribDataType!=null){
                         java.lang.String content = tempAttribDataType;
                        
                                                  object.setDataType(
                                                        com.rightnow.ws.generic.DataTypeEnum.Factory.fromString(reader,tempAttribDataType));
                   ...
                   if (tempAttribName!=null){
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:generic.ws.rightnow.com/v1_3","DataValue").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setDataValue(com.rightnow.ws.generic.DataValue.Factory.parse(reader));
