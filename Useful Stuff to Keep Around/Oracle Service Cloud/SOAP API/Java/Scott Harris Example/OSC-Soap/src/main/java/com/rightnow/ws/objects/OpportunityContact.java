 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for ContactRole
                        */

                        
                                    protected com.rightnow.ws.base.NamedID localContactRole ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localContactRoleTracker = false ;

                           public boolean isContactRoleSpecified(){
                               return localContactRoleTracker;
                           }
                           ...
                           * @return com.rightnow.ws.base.NamedID
                           */
                           public  com.rightnow.ws.base.NamedID getContactRole(){
                               return localContactRole;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ContactRole
                               */
                               public void setContactRole(com.rightnow.ws.base.NamedID param){
                            localContactRoleTracker = true;
                                   
                                            this.localContactRole=param;
                        ...
                        */
                                    ...
                                    protected com.rightnow.ws.nullfields.OpportunityContactNullFields localValidNullFields ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           ...
                           /**
                           * Auto generated getter method
                           * @return com.rightnow.ws.nullfields.OpportunityContactNullFields
                           */
                           public  com.rightnow.ws.nullfields.OpportunityContactNullFields getValidNullFields(){
                            ...
                            /**
                               ...
                               */
                               public void setValidNullFields(com.rightnow.ws.nullfields.OpportunityContactNullFields param){
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":OpportunityContact",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "OpportunityContact",
                ...
                if (localContactTracker){
                                           ...
                                           localContact.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3","Contact"),
                                               xmlWriter);
                                        } if (localContactRoleTracker){
                                    if (localContactRole==null){

                                        writeStartElement(null, "urn:objects.ws.rightnow.com/v1_3", "ContactRole", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localContactRole.serialize(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3","ContactRole"),
                                        xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localContactTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3",
                                    ...
                                    elementList.add(localContactRole==null?null:
                                    localContactRole);
                                } if (localValidNullFieldsTracker){
                            elementList.add(new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3",
                                                                      "ValidNullFields"));
    ...
    public static class Factory{
        ...
        */
        public static OpportunityContact parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"OpportunityContact".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OpportunityContact)com.rightnow.ws.objects.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("urn:objects.ws.rightnow.com/v1_3","ContactRole").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setContactRole(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setContactRole(com.rightnow.ws.base.NamedID.Factory.parse(reader));
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setValidNullFields(com.rightnow.ws.nullfields.OpportunityContactNullFields.Factory.parse(reader));
