 ...
 */
            ...
            /**
            *  TimeBilledNullFields bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                           ...
                           */
                           public  boolean getAccount(){
                            ...
                            /**
                               ...
                               * @param param Account
                               */
                               public void setAccount(boolean param){
                        ...
                        */
                                    ...
                                    protected boolean localBillableTask =
                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean("false");
                           ...
                           * @return boolean
                           */
                           public  boolean getBillableTask(){
                            ...
                            /**
                               ...
                               */
                               public void setBillableTask(boolean param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":TimeBilledNullFields",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "TimeBilledNullFields",
                           xmlWriter);
                   }
                                                ...
                                                writeAttribute("",
                                                         "BillableTask",
                                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localBillableTask), xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            attribList.add(
                            new javax.xml.namespace.QName("","BillableTask"));
                            
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localBillableTask));
    ...
    public static class Factory{
        ...
        */
        public static TimeBilledNullFields parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TimeBilledNullFields object =
                new TimeBilledNullFields();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TimeBilledNullFields".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TimeBilledNullFields)com.rightnow.ws.objects.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                   ...
                   if (tempAttribAccount!=null){
                         java.lang.String content = tempAttribAccount;
                                                 ...
                                                 object.setAccount(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(tempAttribAccount));
                    ...
                    // handle attribute "BillableTask"
                    java.lang.String tempAttribBillableTask =
                        
                                reader.getAttributeValue(null,"BillableTask");
                            
                   if (tempAttribBillableTask!=null){
                         java.lang.String content = tempAttribBillableTask;
                        
                                                 object.setBillableTask(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(tempAttribBillableTask));
                                            
                    } else {
                       
                    }
                    handledAttributes.add("BillableTask");
